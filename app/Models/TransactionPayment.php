...
class TransactionPayment extends Model
{
    ...
    {
        return ! empty($this->document) ? asset('/uploads/documents/'.$this->document) : null;
    }
    ...
    {
        return ! empty(explode('_', $this->document, 2)[1]) ? explode('_', $this->document, 2)[1] : $this->document;
    }
